      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div className="prose-lg">
                <h3 className="text-base font-semibold text-accent uppercase tracking-widest">Our Story</h3>
        ...
        <section id="seva" className="py-20 md:py-28">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto">
              <h3 className="text-base font-semibold text-accent uppercase tracking-widest">Offer Seva</h3>
            ...
            <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <Card key={seva.title} className="flex flex-col text-center rounded-2xl shadow-lg hover:shadow-primary/20 hover:-translate-y-2 transition-all duration-300 border-b-4 border-accent">
        ...
        <section id="gallery" className="py-20 md:py-28 bg-secondary">
          <div className="container mx-auto px-4 md:px-6 text-center">
            <h3 className="text-base font-semibold text-accent uppercase tracking-widest">Gallery</h3>
        ...
        <section id="donate" className="py-20 md:py-28">
          <div className="container mx-auto px-4 md:px-6">
            <div className="bg-gradient-to-br from-primary to-slate-600 text-primary-foreground p-12 md:p-20 rounded-3xl text-center relative overflow-hidden">
