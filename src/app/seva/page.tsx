...
const kripaSeva = [
    { title: "Dry Cake Seeds 30 kg", amount: 650, img: "https://picsum.photos/300/200" },
    { title: "Jaggery 40 Kg", amount: 1000, img: "https://picsum.photos/300/200" },
    { title: "Barley Flour 100 kg", amount: 2000, img: "https://picsum.photos/300/200" },
    { title: "Green Grass for all cows (1 Day)", amount: 3100, img: "https://picsum.photos/300/200" },
    { title: "Medical Care for 1 Cow (1 Month)", amount: 1500, img: "https://picsum.photos/300/200" },
];

const kartavyaSeva = [
    { title: "Sponsor a Cow (1 Month)", amount: 5100, img: "https://picsum.photos/300/200" },
    { title: "Sponsor a Cow (1 Year)", amount: 21000, img: "https://picsum.photos/300/200" },
    { title: "Gau Daan (Donate a Cow)", amount: 51000, img: "https://picsum.photos/300/200" },
];
...
export default function SevaPage() {
    ...
    const SevaCard = ({ title, amount, img }: { title: string; amount: number; img: string; }) => (
        <Card className="overflow-hidden shadow-lg hover:shadow-primary/20 transition-shadow duration-300 group">
            <Image src={img} alt={title} width={300} height={200} className="w-full object-cover group-hover:scale-105 transition-transform" />
            <CardContent className="p-4">
                ...
                <div className="flex justify-between items-center mt-2">
                    ...
                    <Button onClick={() => handleDonation(amount)}>Add Donation</Button>
                </div>
            </CardContent>
        </Card>
    );
  ...
  return (
    <div className="flex flex-col min-h-screen bg-secondary/10">
        ...
        <main className="flex-1">
            <section className="relative bg-primary/10 py-12 md:py-20">
                 <div className="container mx-auto px-4 md:px-6 relative z-10">
                    <div className="grid md:grid-cols-2 items-center gap-8">
                        ...
                        <div className="hidden md:block">
                            <Image src="https://picsum.photos/600/300" alt="Cow" width={600} height={300} className="rounded-lg shadow-xl" data-ai-hint="holy cow"/>
                        </div>
                    </div>
                 </div>
            </section>
                    ...
                    <div className="max-w-5xl mx-auto mt-12">
                         ...
                         <Tabs defaultValue="kripa" className="w-full">
                            <TabsList className="grid w-full grid-cols-2 max-w-md mx-auto mb-8">
                                <TabsTrigger value="kripa">Kripa Seva</TabsTrigger>
                                <TabsTrigger value="kartavya">Kartavya Seva</TabsTrigger>
                            </TabsList>
